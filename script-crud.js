...
const cancelFormBtn = document.querySelector(
...
const localStorageTarefas = localStorage.getItem("tarefas"); // Obtém a string do localStorage
let tarefas = localStorageTarefas ? JSON.parse(localStorageTarefas) : []; // Transforma a string em objeto novamente JSON.parse
...
const updateLocalStorage = () => {
  localStorage.setItem("tarefas", JSON.stringify(tarefas)); // Transforma o objeto em string pelo JSON.stringify
};
